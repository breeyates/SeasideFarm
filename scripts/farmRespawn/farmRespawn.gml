function farmRespawn(gridX, gridY, itemNum){

	show_debug_message("Running farmRespawn")
	
	var cs = 16
	var xx1 = gridX div cs
	var yy1 = gridY div cs
	
	var iGrid = o_itemManager.farm_instances
	...
	if(cell == 0) {
		...
		show_debug_message("Created Inst at: " + string(xx+(cs/2)) + " " + string(yy+(cs/2)) )
